...
#define SF2_INTERRUPTCOND_HEAR_ENEMY (1 << 2)
#define SF2_INTERRUPTCOND_ENEMY_UNREACHABLE (1 << 3)
#define SF2_INTERRUPTCOND_ENEMY_OCCLUDED (1 << 4)
#define SF2_INTERRUPTCOND_LOST_ENEMY (1 << 5)
#define SF2_INTERRUPTCOND_CAN_USE_ATTACK_BEST (1 << 6)
#define SF2_INTERRUPTCOND_DAMAGED (1 << 7)
#define SF2_INTERRUPTCOND_STUNNED (1 << 8)

#define SF2_INTERRUPTCOND_CAN_ATTACK (1 << 9)
#define SF2_INTERRUPTCOND_CAN_ATTACK1 (1 << 10)
#define SF2_INTERRUPTCOND_CAN_ATTACK2 (1 << 11)
#define SF2_INTERRUPTCOND_CAN_ATTACK3 (1 << 12)
#define SF2_INTERRUPTCOND_CAN_ATTACK4 (1 << 13)
#define SF2_INTERRUPTCOND_CAN_ATTACK5 (1 << 14)
#define SF2_INTERRUPTCOND_CAN_ATTACK6 (1 << 15)
#define SF2_INTERRUPTCOND_CAN_ATTACK7 (1 << 16)
#define SF2_INTERRUPTCOND_CAN_ATTACK8 (1 << 17)

#define SF2_INTERRUPTCOND_NEW_SCENT (1 << 18)
#define SF2_INTERRUPTCOND_NEW_GLIMPSE (1 << 19)
#define SF2_INTERRUPTCOND_SEE_GLIMPSE (1 << 20)
#define SF2_INTERRUPTCOND_HEAR_GLIMPSE (1 << 21)
